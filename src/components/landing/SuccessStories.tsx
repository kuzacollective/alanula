...
const stories = [
  ...
  {
    name: "Lina Chun",
    summary: "“I started as a part-time makeup artist, but thanks to Ziada, now it's a full-time gig!”",
    photo: "https://randomuser.me/api/portraits/women/69.jpg",
    category: "Makeup Artist",
  },
  {
    name: "Krish Poolalah",
    summary: "“Photography bookings doubled after joining Ziada. I can focus on my art, not marketing!”",
    photo: "https://randomuser.me/api/portraits/men/44.jpg",
    category: "Photographer",
  },
  {
    name: "Ria Sofa",
    summary: "“I used Ziada to launch my yoga classes for kids and already got 8 new regulars.”",
    ...
    <div className="py-12 md:py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 justify-center">
        {stories.map(story => (
          <div
            key={story.name}
            className="bg-card rounded-xl shadow flex flex-col items-center p-6 animate-fade-in"
          >
            <img
              src={story.photo}
              alt={story.name}
