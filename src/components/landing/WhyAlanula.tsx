  ...
  return (
    <div className="py-16 md:py-24">
      <div className="text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-bold font-poppins text-secondary mb-4">Why Choose Alanula?</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {reasons.map((reason, idx) => (
          <div key={reason.title} className="group">
            <div className="bg-white dark:bg-card rounded-2xl p-8 shadow-sm border hover:shadow-lg transition-all duration-300 hover:-translate-y-1 h-full">
              <div className={`mb-6 p-4 rounded-xl ${reason.color} w-fit group-hover:scale-110 transition-transform duration-300`}>
                {reason.icon}
              </div>
              <h3 className="font-bold font-poppins text-xl text-secondary mb-3">{reason.title}</h3>
              <p className="text-base text-muted-foreground leading-relaxed">{reason.desc}</p>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="text-center mt-16">
        <div className="bg-gradient-to-r from-primary/10 to-accent/10 rounded-2xl p-8 md:p-12">
          <h3 className="text-2xl md:text-3xl font-bold font-poppins text-secondary mb-4">
