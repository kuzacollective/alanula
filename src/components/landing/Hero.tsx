  ...
  return (
    <section className="flex flex-col items-center justify-center py-7 md:py-16 gap-4 bg-background">
      ...
      <h1 className="text-3xl md:text-5xl font-poppins font-bold tracking-tight text-primary text-center mb-3 animate-fade-in">
        Connect with local pros.<br className="hidden md:block" /> Book them in minutes.
      </h1>
      <p className="text-lg md:text-xl font-inter text-muted-foreground text-center mb-6 max-w-xl">
        Alanula will be the fastest, easiest way to find and book trusted local service providers in Mauritius. We're building a platform to help everyday pros gain visibility and grow their income—while helping clients find great help, fast.
      </p>
